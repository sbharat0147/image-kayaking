...
# It pulls every required Docker image, saves them as .tar files, copies all
# project configs, and packs everything into a single transferable archive.
#
...
echo "[1/4] Pulling and saving Docker images..."
echo ""
...
# Copy dc-dr-setup (strip .env if accidentally present)
...
cp "${SCRIPT_DIR}/patches/"* "${BUNDLE_DIR}/patches/" 2>/dev/null || true
